                      ...
                      <div className="max-h-32 overflow-y-auto space-y-2">
                        {contacts.map(contact => (
                          <label key={contact.id} className="flex items-center">
                            <input
                              type="checkbox"
                              checked={editedTask.contactIds.includes(contact.id)}
                              onChange={(e) => {
                                if (e.target.checked) {
                                  setEditedTask({ ...editedTask, contactIds: [...editedTask.contactIds, contact.id] });
                                } else {
                                  setEditedTask({ ...editedTask, contactIds: editedTask.contactIds.filter(id => id !== contact.id) });
                                }
                              }}
                  ...
                  {editedTask.contactIds.length > 0 && (
                    <div className={`mt-3 p-3 border rounded-lg ${
                      ...
                      <p className={`text-sm font-medium mb-2 ${
                        ...
                        Contatos selecionados ({editedTask.contactIds.length}):
                      </p>
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={() => setEditedTask({ 
                                  ...editedTask, 
                                  contactIds: editedTask.contactIds.filter(id => id !== contactId) 
                                })}
